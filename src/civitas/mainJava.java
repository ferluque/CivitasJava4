...
//            Sorpresa sorpresa2 = new Sorpresa("Cumple");
...
//        }
        ...
        Tablero tablero2 = new Tablero(50);
        System.out.println(tablero2.toString());
        System.out.println(tablero.nuevaPosicion(0, Dado.getInstance().tirar()));
        System.out.println(Dado.getInstance().getUltimoResultado());
        System.out.println(tablero.toString());
        System.out.println(tablero.nuevaPosicion(0 + Dado.getInstance().getUltimoResultado(), 20));
        System.out.println(tablero.toString());
    }
